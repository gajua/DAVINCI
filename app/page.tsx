  ...
  return (
    <div className="min-h-screen bg-davinci-darkBlue text-davinci-text">
      ...
      <main className="mx-auto max-w-7xl px-6 py-12">
        <h1 className="mb-8 font-heading text-5xl font-bold text-davinci-accent">
        ...
        <section className="mb-12">
          <h2 className="mb-6 font-heading text-3xl font-bold text-davinci-accent">
            빈티지 관련 소식
          </h2>
          ...
          <div className="mb-6 flex flex-wrap gap-2">
            {categories.map((category) => (
              <Badge
                ...
                variant="outline"
                className={`cursor-pointer rounded-full px-3 py-1 text-xs transition-all duration-300 ${
                  selectedCategory === category
                    ? 'bg-davinci-accent font-semibold text-davinci-darkBlue'
                    : 'border-davinci-lightBlue text-davinci-text hover:bg-davinci-lightBlue hover:text-davinci-text'
                }`}
              >
                {category}
              </Badge>
